...
!function ($) {
	...
	var $menulink           = $('#mainnav-menu > li > a, #mainnav-menu_2 > li > a, #mainnav-menu-wrap .mainnav-widget a[data-toggle="menu-widget"]'),
	...
	unbindSmallNav = function(){
		var colapsed = $('#mainnav-menu, #mainnav-menu_2').find('.collapse');
		if(colapsed.length){
...
$.jasmineNav = function(method,complete){
	...
	jasmine.window.on('load', function() {
		...
		var menu = $('#mainnav-menu, #mainnav-menu_2');
		if (menu.length) {
			...
			// =================================================================
			$('#mainnav-menu, #mainnav-menu_2').metisMenu({
				toggle: true
			});
