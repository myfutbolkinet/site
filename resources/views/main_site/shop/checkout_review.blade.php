        ...
        <div class="container padding-bottom-3x mb-2">
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="checkout-steps"><a class="active" href="/checkout_review">4. Review</a><a class="completed" href="/checkout_payment"><span class="step-indicator icon-circle-check"></span><span class="angle"></span>3. Payment</a><a class="completed" href="/checkout_shipping"><span class="step-indicator icon-circle-check"></span><span class="angle"></span>2. Shipping</a><a class="completed" href="/checkout"><span class="step-indicator icon-circle-check"></span><span class="angle"></span>1. Address</a></div>
                                ...
                                <td>
                                    <div class="product-item"><a class="product-thumb" href="shop-single.html"><img src="/storage/{{$photo->photo}}" alt="Product"></a>
                                        <div class="product-info">
                                            <h4 class="product-title"><a href="shop-single.html">{{$item['item']->name}}<small>x 1</small></a></h4><span><em>Size:</em> 10.5</span><span><em>Color:</em> Dark Blue</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-center text-lg text-medium">{{$item['item']->price}} грн.</td>
                    ...
                    <div class="shopping-cart-footer">
                        ...
                        <div class="column text-lg">Всего: <span class="text-medium">{{$totalPrice}}грн.</span></div>
                    </div>
