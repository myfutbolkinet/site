        ...
        <div class="container padding-bottom-3x mb-2">
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="checkout-steps"><a href="/checkout_review">4. Review</a><a class="active" href="/checkout_payment"><span class="angle"></span>3. Payment</a><a class="completed" href="/checkout_shipping"><span class="step-indicator icon-circle-check"></span><span class="angle"></span>2. Shipping</a><a class="completed" href="/checkout"><span class="step-indicator icon-circle-check"></span><span class="angle"></span>1. Address</a></div>
                    ...
                    <div class="accordion" id="accordion" role="tablist">
                        <div class="card">
                            ...
                            <div class="collapse show" id="card" data-parent="#accordion" role="tabpanel">
                                <div class="card-body">
                                    <p>We accept following credit cards:&nbsp;<img class="d-inline-block align-middle" src="/main_site/img/credit-cards.png" style="width: 120px;" alt="Cerdit Cards"></p>
                    ...
                    <div class="checkout-footer margin-top-1x">
                        <div class="column"><a class="btn btn-outline-secondary" href="checkout_shipping"><i class="icon-arrow-left"></i><span class="hidden-xs-down">&nbsp;Back</span></a></div>
                        <div class="column"><a class="btn btn-primary" href="checkout_review"><span class="hidden-xs-down">Continue&nbsp;</span><i class="icon-arrow-right"></i></a></div>
                    </div>
                </div>
                <!-- Sidebar          -->
