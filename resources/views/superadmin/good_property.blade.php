                                ...
                                <div class="row">
                                    ...
                                    <form id="form" class="addel"
                                        ...
                                        <div class="form-group col-sm-12">
                                            ...
                                            checked
                                            @endif
                                            name="active" value=""> <i></i> Активный</label></div>
                                            </div>
                                            <label class="col-sm-2 control-label"></label>
                                            <div class="col-sm-10">
                                                <div class="i-checks"><label> <input type="checkbox"
                                            ...
                                            checked
                                            @endif
                                            name="main_property" value=""> <i></i> Главное свойство</label></div>
                                            </div>
                                            <label class="col-sm-2 control-label"></label>
                                            <div class="col-sm-10">
                                                <div class="i-checks"><label> <input type="checkbox"
                                            ...
                                            checked
                                            @endif
                                            name="hint" value=""> <i></i> Подсказка</label></div>
                                            </div>
                                            <label class="col-sm-2 control-label"></label>
                                            <div class="col-sm-10">
                                                <div class="i-checks"><label> <input type="checkbox"
                                            ...
                                            checked
                                            @endif
                                            name="show_on_goods_page" value=""> <i></i> Показать на странице товаров</label></div>
                                            </div>
                                            <label class="col-sm-2 control-label"></label>
                                            <div class="col-sm-10">
                                                <div class="i-checks"><label> <input type="checkbox"
                                            ...
                                            checked
                                            @endif
                                             name="show_on_comparison" value=""> <i></i> Показать на странице сравнения товаров</label></div>
                                            </div>
                                            <label class="col-sm-2 control-label"></label>
                                            <div class="col-sm-10">
                                                <div class="i-checks"><label> <input type="checkbox"
                                            ...
                                            checked
                                            @endif
                                            name="show_on_filter" value=""> <i></i> Показать в фильтре</label></div>
                                            </div>
                                            <label class="col-sm-2 control-label"></label>
                                            <div class="col-sm-10">
                                                <div class="i-checks"><label> <input type="checkbox"
                                            ...
                                            checked
                                            @endif
                                            name="multiple" value=""> <i></i> Множественный выбор</label></div>
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-12">
                                            <label class="col-sm-2 control-label"></label>
