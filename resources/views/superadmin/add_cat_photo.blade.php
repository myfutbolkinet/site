...
@section('scripts')
    ...
    $('.cat_name').focus(function (){
        ...
        //mouse leave
        $('.control-label').focus();alert('Чтобы ввести в это поле информацию выберите категорию в таблице ниже,конечная категория будет зафиксированна')
            ...
            $(".fileupload").change(function (e){//input[name='myFile']
                ...
                $.ajax({
                    url: '/superadmin/add_category_photo', // point to server-side PHP script
