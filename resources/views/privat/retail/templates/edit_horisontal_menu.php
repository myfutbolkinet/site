            ...
            <div class="panel panel-default">
                <div class="panel-heading clearfix"><h5 class="pull-left">Menu</h5>
                    <div class="pull-right">
                           ...
                           <button id="btnReload" style="float:left;" type="button" class="btn btn-default">
                            <i class="glyphicon glyphicon-triangle-right"></i> Load Data</button>

                           <button id="btnOut" style="float:left;" type="button" class="btn btn-success">
...
<?php
   // To debug this place In Chrome, press F12
   // Develomping tools-> press F1.
  //  See settings->general->Apperance: "Don't show chrome Data Saver warning"- set this checkbox.
  //  See settings->general->Console: "Log XMLHTTPRequest" - set this checkbox too.
  //  Enjoy
?>
       ...
       /* var strjson1 = '[{"href":"http://home.com","icon":"fa-home","text":"Home"},{"icon":"fa-bar-chart-o","text":"Opcion2"},{"icon":"fa-cloud-upload","text":"Opcion3"},{"icon":"fa-crop","text":"Opcion4"},{"icon":"fa-flask","text":"Opcion5"},' +
        ...
        $('#btnReload').on('click', function () {
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'json',
                url: '/site/get_horisontal',
                success: function(jsondata){
                var strjson1 = JSON.stringify(jsondata);
