    ...
    <div id="navbar-container" class="boxed">
        ...
        <div class="navbar-header">
            <a href="index.html" class="navbar-brand"> <i class="fa fa-cube brand-icon"></i>
                ...
                <img style="width:80%;" src="/img/logo_magelan_black.png">
                </div>
            </a>
        </div>
        <!--================================-->
        ...
        <div class="navbar-content clearfix">
            ...
            <ul class="nav navbar-top-links pull-right">
                ...
                ?>
                    ...
                    <li class="dropdown">
                        <a id="demo-lang-switch" class="lang-selector dropdown-toggle" href="#" data-toggle="dropdown"> <span class="lang-selected"> <img class="lang-flag" src="img/flags/united-kingdom.png" alt="">  <span class="lang-name">Войти</span> </span>
                        </a>


                    </li>
                    <li class="dropdown">
                        <a id="demo-lang-switch" class="lang-selector dropdown-toggle" href="#" data-toggle="dropdown"> <span class="lang-selected"> <img class="lang-flag" src="img/flags/united-kingdom.png" alt="">  <span class="lang-name">Зарегистрироваться</span> </span>
                        </a>
                        ...
                        <ul class="head-list dropdown-menu with-arrow">
                            ...
                            <li>
                                <!--English-->
                                <a href="/register_buyer_view" > <img class="lang-flag" src="img/flags/united-kingdom.png" >  <span class="lang-name">Покупатель</span> </a>
                            </li>
                            <li>
                                <!--France-->
                                <a href="/register_wholeseller_view"> <img class="lang-flag" src="img/flags/france.png" >  <span class="lang-name">Оптовая компания</span> </a>
                            </li>
                            <li>
                                <!--Germany-->
                                <a href="/register_company_view"> <img class="lang-flag" src="img/flags/germany.png" > <span class="lang-id">DE</span> <span class="lang-name">Розничная компания</span> </a>
                            </li>
                            <li>
                                <!--Italy-->
                                <a href="/register_trader_view"> <img class="lang-flag" src="img/flags/italy.png" > <span class="lang-id">IT</span> <span class="lang-name">Биржевой брокер</span> </a>
                            </li>
                            <li>
                                <!--Spain-->
                                <a href="/register_trade_seller_view"> <img class="lang-flag" src="img/flags/spain.png" > <span class="lang-id">ES</span> <span class="lang-name">Продавец на сырьевой бирже</span> </a>
                            </li>
                            <li>
                                <!--Spain-->
                                <a href="/register_expeditor_view"> <img class="lang-flag" src="img/flags/spain.png" > <span class="lang-id">ES</span> <span class="lang-name">Транспортный экспедитор</span> </a>
                            </li>
