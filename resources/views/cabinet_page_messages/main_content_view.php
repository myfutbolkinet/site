                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table id="demo-foo-pagination" class="table toggle-arrow-small tablet breakpoint footable-loaded footable" data-page-size="5">
                                        <thead>
                                        <tr>
                                            <th data-toggle="true" class="footable-visible footable-first-column footable-sortable">Відправник<span class="footable-sort-indicator"></span></th>
                                            <th class="footable-visible footable-last-column footable-sortable">Тема листа<span class="footable-sort-indicator"></span></th>
                                            <th  class="footable-sortable">Дата<span class="footable-sort-indicator"></span></th>
                                            <th class="footable-sortable">Час<span class="footable-sort-indicator"></span></th>
                                        ...
                                        <tr style="display: table-row;" class="footable-even">
                                            ...
                                            <td class="footable-visible footable-last-column"><span class="footable-toggle"></span>Boudreaux</td>
                                            <td class="footable-visible footable-last-column">21/02/2017</td>
                                            <td class="footable-visible footable-last-column">12:30</td>
