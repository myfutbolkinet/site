<header class="site-header navbar-sticky">
    ...
    <div class="topbar d-flex justify-content-between">
        <!-- Logo-->
        <div class="site-branding d-flex"><a class="site-logo align-self-center" href="index.html"><img src="agregator/dist/img/logo/logo.png" alt="Unishop"></a></div>
        <!-- Search / Categories-->
                ...
                <div class="search-box d-flex">
                    <div class="btn-group categories-btn">
                        ...
                        <div class="dropdown-menu mega-dropdown">
                            <div class="row">
                                <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="agregator/dist/img/shop/header-categories/01.jpg"><span class="text-gray-dark">Computers &amp; Accessories</span></a></div>
                                <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="agregator/dist/img/shop/header-categories/02.jpg"><span class="text-gray-dark">Smartphones &amp; Tablets</span></a></div>
                                <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="agregator/dist/img/shop/header-categories/03.jpg"><span class="text-gray-dark">TV, Video &amp; Audio</span></a></div>
                                <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="agregator/dist/img/shop/header-categories/04.jpg"><span class="text-gray-dark">Cameras, Photo &amp; Video</span></a></div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="agregator/dist/img/shop/header-categories/05.jpg"><span class="text-gray-dark">Headphones</span></a></div>
                                <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="agregator/dist/img/shop/header-categories/06.jpg"><span class="text-gray-dark">Wearable Electronics</span></a></div>
                                <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="agregator/dist/img/shop/header-categories/07.jpg"><span class="text-gray-dark">Printers &amp; Ink</span></a></div>
                                <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="agregator/dist/img/shop/header-categories/08.jpg"><span class="text-gray-dark">Video Games</span></a></div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="toolbar d-flex">
            ...
            <div class="toolbar-item hidden-on-mobile"><a href="#">
                    <div><i class="flag-icon"><img src="agregator/dist/img/flags/EN.png" alt="English"></i><span class="text-label">Eng / Usd</span></div></a>
                <ul class="toolbar-dropdown lang-dropdown">
                    ...
                    <li><a href="#"><i class="flag-icon"><img src="agregator/dist/img/flags/FR.png" alt="Français"></i>&nbsp;Français</a></li>
                    <li><a href="#"><i class="flag-icon"><img src="agregator/dist/img/flags/DE.png" alt="Deutsch"></i>&nbsp;Deutsch</a></li>
                    <li><a href="#"><i class="flag-icon"><img src="agregator/dist/img/flags/IT.png" alt="Italiano"></i>&nbsp;Italiano</a></li>
                </ul>
            </div>
            ...
            <div class="toolbar-item"><a href="cart.html">
                ...
                <div class="toolbar-dropdown cart-dropdown widget-cart hidden-on-mobile">
                    <!-- Entry-->
                    <div class="entry">
                        <div class="entry-thumb"><a href="shop-single.html"><img src="agregator/dist/img/shop/widget/04.jpg" alt="Product"></a></div>
                    ...
                    <!-- Entry-->
                    <div class="entry">
                        <div class="entry-thumb"><a href="shop-single.html"><img src="agregator/dist/img/shop/widget/05.jpg" alt="Product"></a></div>
                        <div class="entry-content">
                    ...
                    <!-- Entry-->
                    <div class="entry">
                        <div class="entry-thumb"><a href="shop-single.html"><img src="agregator/dist/img/shop/widget/06.jpg" alt="Product"></a></div>
                        <div class="entry-content">
            ...
            <ul>
                    ...
                    <ul class="sub-menu">
                        <li class="has-children"><a href="index.html">Hero Slider</a>
                            <ul class="sub-menu w-400 p-0 overflow-hidden">
                                <li><a class="p-0" href="index.html"><img src="agregator/dist/img/banners/home01.jpg" alt="Hero Slider Home"></a></li>
                            </ul>
                        </li>
                        <li class="has-children"><a href="home-featured-categories.html">Categories Grid</a>
                            <ul class="sub-menu w-400 p-0 overflow-hidden">
                                <li><a class="p-0" href="home-featured-categories.html"><img src="agregator/dist/img/banners/home02.jpg" alt="Categories Grid Home"></a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
                ...
                <li class="has-megamenu"><a href="#">Mega Menu</a>
                    <ul class="mega-menu">
                        ...
                        <li><a class="card border-0 bg-secondary rounded-0" href="shop-grid-ls.html"><img class="d-block mx-auto" alt="Samsung Galaxy S9" src="agregator/dist/img/banners/mega-menu.jpg"></a></li>
                    </ul>
                </li>
