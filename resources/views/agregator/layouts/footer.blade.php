<footer class="site-footer" style="background-image: url(agregator/dist/img/footer-bg.png);">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <!-- Categories-->
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <section class="widget widget-light-skin">
                    ...
                    <div class="pt-3"><img class="d-block" style="width: 324px;" alt="Cerdit Cards" src="agregator/dist/img/credit-cards-footer.png"></div>
                </section>
            </div>
        </div>
        <!-- Copyright-->
