...
<head>
    ...
    <link rel="stylesheet" media="screen" href="/Futbolki/css/vendor.min.css">
    <!-- Main Template Styles-->
    <link id="mainStyles" rel="stylesheet" media="screen" href="/Futbolki/css/styles.min.css">
    <!-- Modernizr-->
    <script src="/Futbolki/js/modernizr.min.js"></script>
</head>
<!-- Body-->
<body>
...
<div class="offcanvas-container" id="mobile-menu"><a class="account-link" href="account-orders.html">
        <div class="user-ava"><img src="/Futbolki/img/account/user-ava-md.jpg" alt="Daniel Adams">
        </div>
        <div class="user-info">
...
<div class="topbar">
    ...
    <div class="topbar-column"><a class="hidden-md-down" href="#"><i class="icon-download"></i>&nbsp; Get mobile app</a>
        <div class="lang-currency-switcher-wrap">
            <div class="lang-currency-switcher dropdown-toggle"><span class="language"><img alt="English" src="/Futbolki/img/flags/GB.png"></span><span class="currency">$ USD</span></div>
            <div class="dropdown-menu">
                ...
                </div><a class="dropdown-item" href="#"><img src="/Futbolki/img/flags/FR.png" alt="Français">Français</a><a class="dropdown-item" href="#"><img src="/Futbolki/img/flags/DE.png" alt="Deutsch">Deutsch</a><a class="dropdown-item" href="#"><img src="/Futbolki/img/flags/IT.png" alt="Italiano">Italiano</a>
            </div>
        </div>
    </div>
</div>
...
<header class="navbar navbar-sticky">
    ...
    <div class="site-branding">
        <div class="inner">
            ...
            <!-- Site Logo--><a class="site-logo" href="index.html"><img src="/Futbolki/img/logo/logo.png" alt="Unishop"></a>
        </div>
    </div>
    <!-- Main Navigation-->
    <nav class="site-menu">
        <ul>
            <li class="has-megamenu active"><a href="index.html"><span>Home</span></a>
                <ul class="mega-menu">
                    <li><a class="d-block img-thumbnail text-center navi-link" href="index.html"><img alt="Featured Products Slider" src="/Futbolki/img/mega-menu-home/01.jpg">
                            <h6 class="mt-3">Featured Products Slider</h6></a></li>
                    <li><a class="d-block img-thumbnail text-center navi-link" href="home-featured-categories.html"><img alt="Featured Categories" src="/Futbolki/img/mega-menu-home/02.jpg">
                            <h6 class="mt-3">Featured Categories</h6></a></li>
                    <li><a class="d-block img-thumbnail text-center navi-link" href="home-collection-showcase.html"><img alt="Products Collection Showcase" src="/Futbolki/img/mega-menu-home/03.jpg">
                            <h6 class="mt-3">Products Collection Showcase</h6></a></li>
                    <li>
                        <div class="img-thumbnail text-center"><img alt="More To Come. Stay Tuned!" src="/Futbolki/img/mega-menu-home/04.jpg">
            ...
            <li class="has-megamenu"><a href="#"><span>Mega Menu</span></a>
                <ul class="mega-menu">
                    ...
                    <li>
                        <section class="promo-box" style="background-image: url(/Futbolki/img/banners/02.jpg);"><span class="overlay-dark" style="opacity: .4;"></span>
                    ...
                    <li>
                        <section class="promo-box" style="background-image: url(/Futbolki/img/banners/03.jpg);">
            ...
            <div class="tools">
                ...
                <div class="account"><a href="account-orders.html"></a><i class="icon-head"></i>
                    <ul class="toolbar-dropdown">
                        <li class="sub-menu-user">
                            <div class="user-ava"><img src="/Futbolki/img/account/user-ava-sm.jpg" alt="Daniel Adams">
                            </div>
                            <div class="user-info">
                ...
                <div class="cart"><a href="cart.html"></a><i class="icon-bag"></i><span class="count">3</span><span class="subtotal">$289.68</span>
                    <div class="toolbar-dropdown">
                        <div class="dropdown-product-item"><span class="dropdown-product-remove"><i class="icon-cross"></i></span><a class="dropdown-product-thumb" href="shop-single.html"><img src="/Futbolki/img/cart-dropdown/01.jpg" alt="Product"></a>
                        ...
                        <div class="dropdown-product-item"><span class="dropdown-product-remove"><i class="icon-cross"></i></span><a class="dropdown-product-thumb" href="shop-single.html"><img src="/Futbolki/img/cart-dropdown/02.jpg" alt="Product"></a>
                        ...
                        <div class="dropdown-product-item"><span class="dropdown-product-remove"><i class="icon-cross"></i></span><a class="dropdown-product-thumb" href="shop-single.html"><img src="/Futbolki/img/cart-dropdown/03.jpg" alt="Product"></a>
...
<div class="offcanvas-wrapper">
    <!-- Page Content-->
    <!-- Main Slider-->
    <section class="hero-slider" style="background-image: url(/Futbolki/img/hero-slider/main-bg.jpg);">
        <div class="owl-carousel large-controls dots-inside" data-owl-carousel="{ &quot;nav&quot;: true, &quot;dots&quot;: true, &quot;loop&quot;: true, &quot;autoplay&quot;: true, &quot;autoplayTimeout&quot;: 7000 }">
            <div class="item">
                <div class="container padding-top-3x">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-lg-5 col-md-6 padding-bottom-2x text-md-left text-center">
                            <div class="from-bottom"><img class="d-inline-block w-150 mb-4" src="/Futbolki/img/hero-slider/logo02.png" alt="Puma">
                                <div class="h2 text-body text-normal mb-2 pt-1">Закажи логотип на футболку</div>
                                <div class="h2 text-body text-normal mb-4 pb-1">цены от <span class="text-bold">$37.99</span></div>
                            </div><a class="btn btn-primary scale-up delay-1" href="shop-grid-ls.html">Просмотреть</a>
                        </div>
                        <div class="col-md-6 padding-bottom-2x mb-3"><img class="d-block mx-auto" src="/Futbolki/img/hero-slider/02.png" alt="Puma Backpack"></div>
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="container padding-top-3x">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-lg-5 col-md-6 padding-bottom-2x text-md-left text-center">
                            <div class="from-bottom"><img class="d-inline-block w-200 mb-4" src="/Futbolki/img/hero-slider/logo01.png" alt="Converse">
                        ...
                        <div class="col-md-6 padding-bottom-2x mb-3"><img class="d-block mx-auto" src="/Futbolki/img/hero-slider/01.png" alt="Chuck Taylor All Star II"></div>
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="container padding-top-3x">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-lg-5 col-md-6 padding-bottom-2x text-md-left text-center">
                            <div class="from-bottom"><img class="d-inline-block mb-4" src="/Futbolki/img/hero-slider/logo03.png" style="width: 125px;" alt="Motorola">
                        ...
                        <div class="col-md-6 padding-bottom-2x mb-3"><img class="d-block mx-auto" src="/Futbolki/img/hero-slider/03.png" alt="Moto 360"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6">
                <div class="card mb-30"><a class="card-img-tiles" href="shop-grid-ls.html">
                        <div class="inner">
                            <div class="main-img"><img src="/Futbolki/img/shop/categories/01.jpg" alt="Category"></div>
                            <div class="thumblist"><img src="/Futbolki/img/shop/categories/02.jpg" alt="Category"><img src="/Futbolki/img/shop/categories/03.jpg" alt="Category"></div>
                        </div></a>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="card mb-30"><a class="card-img-tiles" href="shop-grid-ls.html">
                        <div class="inner">
                            <div class="main-img"><img src="/Futbolki/img/shop/categories/04.jpg" alt="Category"></div>
                            <div class="thumblist"><img src="/Futbolki/img/shop/categories/05.jpg" alt="Category"><img src="/Futbolki/img/shop/categories/06.jpg" alt="Category"></div>
                        </div></a>
                    <div class="card-body text-center">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="card mb-30"><a class="card-img-tiles" href="shop-grid-ls.html">
                        <div class="inner">
                            <div class="main-img"><img src="/Futbolki/img/shop/categories/07.jpg" alt="Category"></div>
                            <div class="thumblist"><img src="/Futbolki/img/shop/categories/08.jpg" alt="Category"><img src="/Futbolki/img/shop/categories/09.jpg" alt="Category"></div>
                        </div></a>
                    <div class="card-body text-center">
    ...
    <section class="container-fluid padding-top-3x">
        <div class="row justify-content-center">
            ...
            <div class="col-xl-5 col-lg-6 mb-30" style="min-height: 270px;">
                <div class="img-cover rounded" style="background-image: url(/Futbolki/img/banners/home01.jpg);"></div>
            </div>
        </div>
    </section>
    <!-- Promo #2-->
    <section class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-xl-10 col-lg-12">
                <div class="fw-section rounded padding-top-4x padding-bottom-4x" style="background-image: url(/Futbolki/img/banners/home02.jpg);"><span class="overlay rounded" style="opacity: .35;"></span>
                    <div class="text-center">
        ...
        <div class="owl-carousel" data-owl-carousel="{ &quot;nav&quot;: false, &quot;dots&quot;: true, &quot;margin&quot;: 30, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:1},&quot;576&quot;:{&quot;items&quot;:2},&quot;768&quot;:{&quot;items&quot;:3},&quot;991&quot;:{&quot;items&quot;:4},&quot;1200&quot;:{&quot;items&quot;:4}} }">
            ...
            <div class="grid-item">
                <div class="product-card">
                    <div class="product-badge text-danger">22% Off</div><a class="product-thumb" href="shop-single.html"><img src="/Futbolki/img/shop/products/09.jpg" alt="Product"></a>
            ...
            <div class="grid-item">
                <div class="product-card">
                    ...
                    </div><a class="product-thumb" href="shop-single.html"><img src="/Futbolki/img/shop/products/03.jpg" alt="Product"></a>
            ...
            <!-- Product-->
            <div class="grid-item">
                <div class="product-card"><a class="product-thumb" href="shop-single.html"><img src="/Futbolki/img/shop/products/12.jpg" alt="Product"></a>
            ...
            <div class="grid-item">
                <div class="product-card">
                    ...
                    </div><a class="product-thumb" href="shop-single.html"><img src="/Futbolki/img/shop/products/11.jpg" alt="Product"></a>
            ...
            <!-- Product-->
            <div class="grid-item">
                <div class="product-card"><a class="product-thumb" href="shop-single.html"><img src="/Futbolki/img/shop/products/04.jpg" alt="Product"></a>
            ...
            <div class="grid-item">
                <div class="product-card">
                    <div class="product-badge text-danger">50% Off</div><a class="product-thumb" href="shop-single.html"><img src="/Futbolki/img/shop/products/01.jpg" alt="Product"></a>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6">
                <div class="widget widget-featured-products">
                    ...
                    <!-- Entry-->
                    <div class="entry">
                        <div class="entry-thumb"><a href="shop-single.html"><img src="/Futbolki/img/shop/widget/01.jpg" alt="Product"></a></div>
                    ...
                    <!-- Entry-->
                    <div class="entry">
                        <div class="entry-thumb"><a href="shop-single.html"><img src="/Futbolki/img/shop/widget/03.jpg" alt="Product"></a></div>
                        <div class="entry-content">
                    ...
                    <!-- Entry-->
                    <div class="entry">
                        <div class="entry-thumb"><a href="shop-single.html"><img src="/Futbolki/img/shop/widget/04.jpg" alt="Product"></a></div>
                        <div class="entry-content">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="widget widget-featured-products">
                    ...
                    <!-- Entry-->
                    <div class="entry">
                        <div class="entry-thumb"><a href="shop-single.html"><img src="/Futbolki/img/shop/widget/05.jpg" alt="Product"></a></div>
                        <div class="entry-content">
                    ...
                    <!-- Entry-->
                    <div class="entry">
                        <div class="entry-thumb"><a href="shop-single.html"><img src="/Futbolki/img/shop/widget/06.jpg" alt="Product"></a></div>
                        <div class="entry-content">
                    ...
                    <!-- Entry-->
                    <div class="entry">
                        <div class="entry-thumb"><a href="shop-single.html"><img src="/Futbolki/img/shop/widget/07.jpg" alt="Product"></a></div>
                        <div class="entry-content">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="widget widget-featured-products">
                    ...
                    <!-- Entry-->
                    <div class="entry">
                        <div class="entry-thumb"><a href="shop-single.html"><img src="/Futbolki/img/shop/widget/08.jpg" alt="Product"></a></div>
                        <div class="entry-content">
                    ...
                    <!-- Entry-->
                    <div class="entry">
                        <div class="entry-thumb"><a href="shop-single.html"><img src="/Futbolki/img/shop/widget/09.jpg" alt="Product"></a></div>
                        <div class="entry-content">
                    ...
                    <!-- Entry-->
                    <div class="entry">
                        <div class="entry-thumb"><a href="shop-single.html"><img src="/Futbolki/img/shop/widget/10.jpg" alt="Product"></a></div>
                        <div class="entry-content">
    ...
    <section class="bg-faded padding-top-3x padding-bottom-3x">
        <div class="container">
            ...
            <div class="owl-carousel" data-owl-carousel="{ &quot;nav&quot;: false, &quot;dots&quot;: false, &quot;loop&quot;: true, &quot;autoplay&quot;: true, &quot;autoplayTimeout&quot;: 4000, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:2}, &quot;470&quot;:{&quot;items&quot;:3},&quot;630&quot;:{&quot;items&quot;:4},&quot;991&quot;:{&quot;items&quot;:5},&quot;1200&quot;:{&quot;items&quot;:6}} }"><img class="d-block w-110 opacity-75 m-auto" src="/Futbolki/img/brands/01.png" alt="Adidas"><img class="d-block w-110 opacity-75 m-auto" src="/Futbolki/img/brands/02.png" alt="Brooks"><img class="d-block w-110 opacity-75 m-auto" src="/Futbolki/img/brands/03.png" alt="Valentino"><img class="d-block w-110 opacity-75 m-auto" src="/Futbolki/img/brands/04.png" alt="Nike"><img class="d-block w-110 opacity-75 m-auto" src="/Futbolki/img/brands/05.png" alt="Puma"><img class="d-block w-110 opacity-75 m-auto" src="/Futbolki/img/brands/06.png" alt="New Balance"><img class="d-block w-110 opacity-75 m-auto" src="/Futbolki/img/brands/07.png" alt="Dior"></div>
        </div>
    </section>
    <!-- Services-->
    <section class="container padding-top-3x padding-bottom-2x">
        <div class="row">
            <div class="col-md-3 col-sm-6 text-center mb-30"><img class="d-block w-90 img-thumbnail rounded-circle mx-auto mb-3" src="/Futbolki/img/services/01.png" alt="Shipping">
                <h6>Free Worldwide Shipping</h6>
                <p class="text-muted margin-bottom-none">Free shipping for all orders over $100</p>
            </div>
            <div class="col-md-3 col-sm-6 text-center mb-30"><img class="d-block w-90 img-thumbnail rounded-circle mx-auto mb-3" src="/Futbolki/img/services/02.png" alt="Money Back">
                <h6>Money Back Guarantee</h6>
                <p class="text-muted margin-bottom-none">We return money within 30 days</p>
            </div>
            <div class="col-md-3 col-sm-6 text-center mb-30"><img class="d-block w-90 img-thumbnail rounded-circle mx-auto mb-3" src="/Futbolki/img/services/03.png" alt="Support">
                <h6>24/7 Customer Support</h6>
                <p class="text-muted margin-bottom-none">Friendly 24/7 customer support</p>
            </div>
            <div class="col-md-3 col-sm-6 text-center mb-30"><img class="d-block w-90 img-thumbnail rounded-circle mx-auto mb-3" src="/Futbolki/img/services/04.png" alt="Payment">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-7 padding-bottom-1x">
                    <!-- Payment Methods-->
                    <div class="margin-bottom-1x" style="max-width: 615px;"><img src="/Futbolki/img/payment_methods.png" alt="Payment Methods">
                    </div>
                </div>
...
<script src="/Futbolki/js/vendor.min.js"></script>
<script src="/Futbolki/js/scripts.min.js"></script>
</body>
</html>