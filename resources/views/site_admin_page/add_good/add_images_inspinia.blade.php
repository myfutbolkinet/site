...
<script>
    $(document).ready(function() {
        ...
        fileInput.damnUploader({
            // куда отправлять
            url: '/admin/Ajax/FuncImagesClass',
            ...
            onSelect: function(file) {
                viewFile(file);
                console.log('появился новый файл');
                return false;
            },
            // когда все загружены
                ...
                fileInput.damnUploader('addItem', {
                    ...
                    onComplete: function(successfully, data, errorCode) {
                        if(successfully) {
                            ...
                            if(!this.cancelled) {
                                log('<span style="color:red;">Файл `'+files[int].name+'`: ошибка при загрузке. Код of error: '+errorCode+'</span>');
                            }
                        }
