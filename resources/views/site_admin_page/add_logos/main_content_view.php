<div class="boxed">
    ...
    <div id="content-container">
        ...
        <!--Page Title-->
        <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <div style= "margin-top:50px;margin-left:400px" class="pageheader">
                ...
                <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <!-- START Form Wizard -->
                            <form class="form-horizontal form-bordered" method="post" action="/functions_form_logo" id="wizard-validate">
                                <!-- Wizard Container 1 -->
                                ...
                                <div class="wizard-container">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <h5 class="semibold text-primary">
                                                <i class="fa fa-sign-in"></i> Основна iнформація
                                            </h5>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control" name="address" type="text" placeholder="Введить адрес партнера" data-parsley-group="order" data-parsley-required />
                                        </div>
                                    </div>
