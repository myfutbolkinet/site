...
use DOMDocument;
class CategoriesSeedtToXmlController extends Controller
{
    ...
    function createXML($data) {
        ...
        foreach($data as $user){
            if(!empty($user)){
                $tabUser = $tabUsers->appendChild($xmlDoc->createElement('category'));
    ...
    public function from(){
        $path = base_path('/database/seeds/categories.xml');
